...
# 🔥 GET DATABASE URL
db_url = os.getenv("mysql://root:yqpWrXoyEaSYofbMSNOyBUFEFWoFZmtG@interchange.proxy.rlwy.net:43119/railway")

# 👉 fallback for local testing (IMPORTANT)
if not db_url:
    db_url = "mysql://root:yqpWrXoyEaSYofbMSNOyBUFEFWoFZmtG@interchange.proxy.rlwy.net:43119/railway"
